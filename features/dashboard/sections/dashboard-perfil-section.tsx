...
import type { ProfileFormState, SaveStatus } from '@/features/dashboard/use-dashboard-controller'
...
type DashboardPerfilSectionProps = {
  ...
  onImageUpload: (field: 'profileImage' | 'bannerImage', file: File | undefined) => Promise<void>
  onSave: () => Promise<void>
}
